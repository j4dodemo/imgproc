...
public class FilterAdapter extends CommonAdapter<OptionBean> {
	private List<OptionBean> data;

	public FilterAdapter(Context context, List<OptionBean> data) {
	...
	public void convert(ViewHolder holder, OptionBean optionBean) {
		...
		data.get(MainActivity.lastFilterPosition).setSelect(true);
		
		

		if (optionBean.isSelect()) {
			selectImg.setVisibility(View.VISIBLE);
			MainActivity.lastFilterSelect = selectImg;
		} else {
